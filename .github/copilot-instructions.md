...
- **GitHub**: `github.com/steled/shopping-list`
- **Remote**: `https://github.com/steled/shopping-list.git`
...
| Artifact  | Registry                                                               |
|-----------|------------------------------------------------------------------------|
| Docker    | `ghcr.io/steled/shopping-list`                                         |
| Helm OCI  | `oci://ghcr.io/steled/charts/shopping-list`                            |
